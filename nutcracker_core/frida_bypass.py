    ...
    function _patchHierarchy(cls) {
      try {
        ...
        if (!_patched['__app_detection_init']) {
          ...
          // OfficialDevice
          try {
            var OD = Java.use('com.example.app.util.officialdevice.OfficialDevice');
          ...
          // FindEmulator
          try {
            var FE = Java.use('com.example.app.util.officialdevice.FindEmulator');
          ...
          // RootUtil
          try {
            var RU = Java.use('com.example.app.util.RootUtil');
